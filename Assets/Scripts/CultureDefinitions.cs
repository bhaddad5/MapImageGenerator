...
public static class CultureDefinitions
{
	public static Culture Anglo = new Culture()
	{
		...
		areaInfo = new List<NameOption>()
		{
			...
			new NameOption("%n Castle", new List<Settlement.CityTrait> { Settlement.CityTrait.Large }),
			new NameOption("Castle %n", new List<Settlement.CityTrait> { Settlement.CityTrait.Large }),
			new NameOption("%n Hold", new List<Settlement.CityTrait> { Settlement.CityTrait.Medium }),
			new NameOption("%n Hall", new List<Settlement.CityTrait> { Settlement.CityTrait.Medium }),
			new NameOption("%n Stead", new List<Settlement.CityTrait> { Settlement.CityTrait.Small }),
